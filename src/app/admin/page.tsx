                      ...
                      <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-lg px-4 py-2">
                        <div className="text-center">
                          <div className="text-lg font-bold text-green-600">
                            ${pagos.filter(pago => pago.estado === 'aprobado').reduce((sum, pago) => sum + pago.monto, 0).toLocaleString('es-CO')}
                          </div>
                          <div className="text-xs text-green-700">Total Aprobado</div>
                        </div>
                      </div>
                      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg px-4 py-2">
                        <div className="text-center">
                          <div className="text-lg font-bold text-blue-600">{pagos.filter(pago => pago.estado === 'aprobado').length}</div>
                          <div className="text-xs text-blue-700">Aprobadas</div>
                        </div>
                      </div>
                    </div>
                  )}
